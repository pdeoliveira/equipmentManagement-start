...
describe('Component Tests', () => {
  describe('StoreEquipment Management Component', () => {
    let comp: StoreEquipmentComponent;
    let fixture: ComponentFixture<StoreEquipmentComponent>;
    let service: StoreEquipmentService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [EquipmentManagementTestModule],
        declarations: [StoreEquipmentComponent],
        providers: [
          {
        ...
        .overrideTemplate(StoreEquipmentComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(StoreEquipmentComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.storeEquipments && comp.storeEquipments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
